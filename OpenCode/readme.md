...
`podman run -it --name opencode -v ./:/home/dev/projects  localhost/opencode:latest`
...
`podman run -it --name opencode -v $(pwd):/home/dev/projects:Z  localhost/opencode:latest`
